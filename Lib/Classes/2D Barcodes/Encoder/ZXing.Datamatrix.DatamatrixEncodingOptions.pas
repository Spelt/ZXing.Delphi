...
uses
  ZXing.Datamatrix.DatamatrixEncodingOptions;

type    
  /// <summary>
  /// The class holds the available options for the DatamatrixWriter
  /// </summary>
  TDataMatrixEncodingOptions = class(TEncodingOptions)
  private
	FDefaultEncodation,
	FSymbolShape,        : Nullable<Integer>;
    FMaxSize,
	FMinSize             : TDimension;
  public
    property DefaultEncodation: Nullable<Integer> read FDefaultEncodation write FDefaultEncodation;
    property MaxSize: TDimension read FMaxSize write FMaxSize;
    property MinSize: TDimension read FMinSize write FMinSize;
    property SymbolShape: Nullable<SymbolShapeHint> read FSymbolShape write FSymbolShape;
  end;
...
(*
 ...
 TODO (KG) - Complete implementation
